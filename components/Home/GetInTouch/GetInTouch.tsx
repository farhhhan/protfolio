...
export default function GetInTouch() {
  ...
  return (
    <div
      ...
      data-aos="fade-up"
      className="flex flex-col space-y-4 w-full h-96 items-center bg-AAprimary pt-20"
    >
      {/* // ? Title === > What's Next?  */}
      ...
      <div className="pt-4">
        {isAndroidWebView ? (
          ...
          >
            farhanabdullahpc01@gmail.com
          </button>
        ) : (
          <div className="flex flex-row">
            <a href="mailto:farhanabdullahpc01@gmail.com" target="_blank" rel="noreferrer">
