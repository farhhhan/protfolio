...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!IsBlackListEmpty) {
      if (userData) {
        ...
        if (process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES && process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES.includes(userData.country)) {
  ...
  const meta = {
    title: "Farhan - Flutter Developer | Mobile App Development",
    description: `Dedicated Flutter developer with 3+ years of experience building cross-platform applications. Skilled in Firebase, REST APIs, and Bloc state management. Get in touch to know more.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://farhan.com`} />
        <link rel="canonical" href={`https://farhan.com`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Farhan" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@farhan" />
